...
"$RUST_CARGO" build --locked --manifest-path "$PROJECT_DIR/native/Cargo.toml" --target aarch64-linux-android --release
...
"$RUST_CARGO" build --locked --manifest-path "$PROJECT_DIR/native/Cargo.toml" --target x86_64-linux-android --release
